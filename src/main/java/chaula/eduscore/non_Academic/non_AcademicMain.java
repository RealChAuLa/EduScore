...
public class non_AcademicMain  {
    double xOffset = 0;
    double yOffset = 0;
    public void non_AcademicWindow(Stage primaryStage) throws IOException {

        System.out.println("NON Academic window Started");
        FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("non_AcademicView.fxml"));
