...
public class edit_StudentMain {
    double xOffset = 0;
    double yOffset = 0;
    public void edit_StudentWindow(Stage primaryStage) throws IOException {
        System.out.println("Starting edit_Student window");
        FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("edit_StudentView.fxml"));
        Scene scene = new Scene(fxmlLoader.load());
        scene.setFill(Color.TRANSPARENT);
        primaryStage.setScene(scene);
        primaryStage.setResizable(false);
        primaryStage.setTitle("Student Edit Panel");
